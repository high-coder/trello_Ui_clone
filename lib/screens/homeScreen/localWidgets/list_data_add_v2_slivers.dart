                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Consumer<CurrentState>(
                                      builder: (context, _, __) {
                                        print(
                                            "tinis inside here this is getting serious now and i dont know what to doi ");

                                        if (sampleNodes[index].labels == null) {
                                          return Container();
                                        } else if (sampleNodes[index]
                                                .labels
                                                ?.isNotEmpty ??
                                            false) {
                                          return Wrap(
                                ...
                                children: [
                                  LongPressDraggable<ListTileSingleNodeModel>(
                                    ...
                                    onDragStarted: () {
                                      print("The dragging is kinda started");
                                      _respInstance
                                          .updateAppBar(AppBarState.Drag);
                                    },
                                    onDragEnd: (value) {
                                      _respInstance
                                          .updateAppBar(AppBarState.Name);
                                    },
                                    onDragCompleted: () {
                                      _respInstance
                                          .updateAppBar(AppBarState.Name);
                                  ...
                                  _respInstance.showAddCard == true
                                      ? Container(
                                          ...
                                          child: TextField(
                                            ...
                                            onChanged: (value) {
                                              if (_respInstance
                                                      .cardName.text.length >=
                                                  1) {
                                                _respInstance
                                                    .enableSavingFunc(true);
                                              } else {
                                                _respInstance
                                                    .enableSavingFunc(false);
                                              }
                                            },
...
//                            color: lightBlack,
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      GestureDetector(
                                        onTap: () {
                                          print("this is being pressed here");
                                        },
                                        child: Container(
