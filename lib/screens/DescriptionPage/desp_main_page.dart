...
import 'localWidgets/lablesWidget.dart';
          ...
          body: SafeArea(
            child: CustomScrollView(
              ...
              slivers: [
                                ...
                                children: [
                                  IconButton(
                                    onPressed: () {
                                      ...
                                      _titleFocus.unfocus();
                                      _despFocus.unfocus();
                                      _respHelp.appBarStateDesp =
                                          AppBarStateDesp.Name;
                                  ...
                                  Text(
                                    _instance.appBarTitle,
                                    style: GoogleFonts.openSans(
                                        fontSize: 15, color: ourWhite),
                                  ),
                                  const Spacer(flex: 1),
                                  IconButton(
                ...
                SliverToBoxAdapter(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: const Color(0xff252525),
                        border: Border.all(
                            color: const Color(0xff111111), width: 1)),
                    child: TextFormField(
                      ...
                      style:
                          GoogleFonts.openSans(color: ourWhite, fontSize: 16),
                      ...
                      decoration: InputDecoration(
                          ...
                          disabledBorder: UnderlineInputBorder(
                              borderSide:
                                  BorderSide(color: addGreen, width: 5)),
                          focusedBorder: UnderlineInputBorder(
                              borderSide:
                ...
                Consumer<ResponsiveHelp>(
                  builder: (context, _, __) {
                    switch (_respHelp.labelsEnum) {
                      case (LabelsEnum.Empty):
                        return SliverToBoxAdapter(
                          child: Container(
                            ...
                            child: InkWell(
                              onTap: () {
                                _respHelp.labelsEnumStateChange(
                                    LabelsEnum.FullExpanded);
                              },
                              child: Row(
                                children: [
                                  Expanded(
                      ...
                      case (LabelsEnum.FullButNotExpanded):
                        return SliverToBoxAdapter();
                      case (LabelsEnum.FullExpanded):
                        return SliverList(
                            delegate: SliverChildBuilderDelegate(
                          (BuildContext context, int index) {
                            return LablesWidget(
                              labels: colorsModel[index],
                            );
                          },
                          childCount: colorsModel.length,
                        ));
                      default:
                        return SliverToBoxAdapter(
                          child: Container(),
                ...
                SliverList(
                  ...
                  (BuildContext context, int index) {
                    return CommentWidget(
                      commentThing: _instance.currentUser.comments![index],
                    );
                  },
                  childCount: _instance.currentUser.comments != null
                      ? _instance.currentUser.comments?.length
                      : 0,
                )),
              ],
            ),
